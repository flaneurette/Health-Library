...
> TIP: some sockets can be reversed (check if it's possible) this makes it easier to switch the socket 90 degrees, so that the wire-color is similar as to the table below. This prevents tearing wires if they are clipped or screwed too tightly. Making it an EASY FIX.
